...
def _resize_image_size(train_x,new_size):
    
    new_image = resize(train_x, (new_size, new_size, 1), mode='constant',
                       preserve_range=True)
...
def ETL_data_loading(new_size,plot_train_sample = False,
    ...
    for test_id_i in test_ids:
        ...
        if count_image == sample_id and sample_id_test:
    ...
    return dataframe_depth, train_x_resized, train_y_resized, test_x_resized

#ETL_data_loading(128,True,False)
